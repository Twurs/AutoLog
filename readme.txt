# Proyecto de Tesis: AutoLog

Esta es una aplicación web para la gestión de mantenimiento vehicular.
...
1.  Abrir el archivo `perfil.html` en cualquier navegador web.